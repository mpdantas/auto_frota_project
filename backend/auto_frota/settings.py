"""
Django settings for auto_frota project.
...
SECRET_KEY = 'django-insecure-o_o9)f&ocz2y4l5dl$=b0tx5y&p)y8j#alq^_sj6@0k=sjh@+#'
...
WSGI_APPLICATION = 'auto_frota.wsgi.application'
